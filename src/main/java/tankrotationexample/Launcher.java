...
import tankrotationexample.menus.Player1WinsPanel;
import tankrotationexample.menus.Player2WinsPanel;
...
public class Launcher {
    ...
    private JPanel player1Wins;
    private JPanel player2Wins;
    ...
    private void initUIComponents(){                                                                // starts the entire game
        ...
        this.player1Wins = new Player1WinsPanel(this);
        this.player2Wins = new Player2WinsPanel(this);
        ...
        this.mainPanel.add(player1Wins, "Player1Wins"); //add the player1wins panel to the main panel
        this.mainPanel.add(player2Wins, "Player2Wins");   //add the player2wins panel to the main panel
